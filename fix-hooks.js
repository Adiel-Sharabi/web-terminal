...
// All eight, and the set is not optional (this assignment REPLACES s.hooks):
...
//    idle.
//  - PreCompact drives the "Compacting conversation…" indicator (#65). Keep this
//    list identical to the one in README.md.
const EVENTS = ["UserPromptSubmit","PreToolUse","PostToolUse","SubagentStart","SubagentStop","Notification","Stop","PreCompact"];
