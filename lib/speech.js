...
//
// The class lists the variation selectors (FE00-FE0F) and ZWJ (200D) as standalone
// members deliberately, so they are deleted individually. `no-misleading-character-class`
// guards against splitting a grapheme cluster by accident; here every code point of an
// emoji ZWJ sequence is in the class, so the whole cluster goes — and a joiner left
// behind by a partial match is exactly the artefact this line exists to remove.
