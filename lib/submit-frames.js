...
function bracketLongBody(head, limit) {
  ...
  // BYTES, and the conversion comes FIRST — measured in bytes because the cliff is a
  // 1024-BYTE read boundary in the TUI, and the two callers do not agree otherwise:
