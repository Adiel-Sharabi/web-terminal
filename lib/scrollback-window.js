...
// `globalThis`, not `self`: it is defined in Node and in the browser alike, so
// the file lints under the Node config it is tested with while still reaching
// `app.html` as `window.WTScrollback`.
if (typeof module !== 'undefined' && module.exports) module.exports = _api;
else globalThis.WTScrollback = _api;
