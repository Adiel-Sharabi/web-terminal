...
// Per-kind TTL (seconds) and priority. approval/apierror/clear are time-sensitive
// (high); idle is not (normal — protects the Android high-priority quota).
const FCM_TTL_SECONDS = { approval: 300, apierror: 600, idle: 3600, clear: 60 };
const HIGH_PRIORITY_KINDS = new Set(['approval', 'apierror', 'clear']);
