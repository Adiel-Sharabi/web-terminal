...
// came to submit with that question blank. The preview BODY is deliberately not
// forwarded (it is free-form and can be large, and no client renders it) — only
// the fact that one exists. Layout is per-QUESTION, not per-prompt: measured
// 2026-08-03 against claude 2.1.220, a previewed Q1 rendered side-by-side while
// the same prompt's preview-less multi-select Q2 rendered compact.
