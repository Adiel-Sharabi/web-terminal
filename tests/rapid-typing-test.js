...
const XPS_URL = 'https://***REDACTED***';
const XPS_TOKEN = '***REDACTED-TOKEN***';
const LOCAL_URL = 'http://localhost:7681';
const LOCAL_TOKEN = '***REDACTED-TOKEN***';
...
async function main() {
  ...
  console.log('\n--- DIRECT to XPS ---');
  const directWs = await connectWs(`wss://***REDACTED***/ws/${sid}?token=${XPS_TOKEN}`);
