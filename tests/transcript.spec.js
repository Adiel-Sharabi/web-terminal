...
test.describe('lib/transcript.claudeProjectDirName', () => {
  test('maps the reported bug case: C:\\dev\\AM8_Core -> C--dev-AM8-Core', () => {
    // Was C--dev-AM8_Core under the old encoder (underscore kept) -> 404 -> no Chat.
    expect(claudeProjectDirName('C:\\dev\\AM8_Core')).toBe('C--dev-AM8-Core');
  });
