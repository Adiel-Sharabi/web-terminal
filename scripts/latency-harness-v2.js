...
const OFFICE = 'http://***REDACTED-IP***:7784';
const HOME   = 'http://***REDACTED-IP***:7785';
const XPS    = 'http://***REDACTED-IP***:7786';
const OFFICE_TOKEN = '***REDACTED-TOKEN***';
const HOME_TOKEN   = '***REDACTED-TOKEN***';
...
(async () => {
  ...
  const proxyUrl  = `ws://***REDACTED-IP***:7784/cluster/${encodeURIComponent(HOME)}/ws/${sid}?token=${OFFICE_TOKEN}`;
